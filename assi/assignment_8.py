...
arrAll = np.hstack([arr1, arr2, arr3])

scaler = skprepro.StandardScaler()

scaler_f = scaler.fit_transform(arrAll)
# print(arrAll)
# print(scaler_f)


data_x_train, data_x_test = sksel.train_test_split(scaler_f, train_size = 0.75, shuffle = False)
# print(data_x_train)
# print(data_x_test)
